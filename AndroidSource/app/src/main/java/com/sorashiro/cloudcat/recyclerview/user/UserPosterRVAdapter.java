...
public class UserPosterRVAdapter extends RecyclerView.Adapter<UserPosterBaseVH> {

    private Context                                       mContext;
    private List<PosterBean>                              mList;
    private RecyclerViewClickListener.OnItemClickListener mOnItemClickListener;

    public UserPosterRVAdapter(Context context, List<PosterBean> lists) {
    ...
    @Override
    public UserPosterBaseVH onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
            case PosterBean.TYPE_PHOTO:
                ...
                UserPosterVH photoVH = new UserPosterVH(photoView);
                return photoVH;
            ...
            case PosterBean.TYPE_FORWARD:
                ...
                UserPosterForwardVH forwardVH = new UserPosterForwardVH(forwardView);
                return forwardVH;
        }
        return null;
    }
    ...
    @Override
    public void onBindViewHolder(final UserPosterBaseVH holder, int position) {
        ...
        int l_num = posterBean.getLike_num();
        final boolean[] if_like = {posterBean.isIf_like()};
        switch (p_type) {
            case PosterBean.TYPE_PHOTO:
                final UserPosterVH homeViewHolder = (UserPosterVH) holder;
            ...
            case PosterBean.TYPE_VIDEO:
                break;
            case PosterBean.TYPE_FORWARD:
                final UserPosterForwardVH homeFVH = (UserPosterForwardVH) holder;
