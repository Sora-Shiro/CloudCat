...
public class UserOtherFollowingRVAdapter extends RecyclerView.Adapter<UserFollowingVH> {

    private Context                                       mContext;
    private ArrayList<OtherFollowBean>                    mList;
    private RecyclerViewClickListener.OnItemClickListener mOnItemClickListener;

    public UserOtherFollowingRVAdapter(Context context, ArrayList<OtherFollowBean> lists) {
    ...
    public void onBindViewHolder(final UserFollowingVH holder, final int position) {
        ...
        holder.textName.setText(otherFollowBean.getU2());
        ...
        Picasso.with(mContext)
                .load(Constant.BASE_STATIC_AVATAR_URL + otherFollowBean.getU2())
